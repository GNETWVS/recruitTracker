function outImg = rT_fixSubtractionArtifacts(inImg)
...
% inImg is the RGB input image. It is expected to be 8-bit integer, between
% 0 and 255.
inImg = uint8(255*double(inImg)./max(double(inImg(:))));
