function [ Out,Summed ] = rT_mergeTrioPair(amb_im_path, white_im_path, fluo_im_path)
...
ambientImage = rT_adjust(ambientImgLinear,0.55,2,[0.1 0.999]);
fluoresenceImage = rT_adjust(fluroImgLinear,0.55,2,[0.1 0.999]);
whiteImage = rT_adjust(whiteImgLinear,0.55,1,[0.1 0.999]);
...
% Subtracted image
R = rT_subtractImagesRatio(flr,amb);
